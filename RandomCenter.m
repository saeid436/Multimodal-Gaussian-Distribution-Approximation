...
% Choosing centers in random way...
...
Sample1 = [u1(1) + q1*rand(1,30); u1(2) + q1*rand(1,30)]; %Samplin First Function
Sample2 = [u2(1) + q2*rand(1,30); u2(2) + q2*rand(1,30)]; %Samplin Second Function
Sample3 = [u3(1) + q3*rand(1,30); u3(2) + q3*rand(1,30)]; %Samplin Third Function
Sample4 = [u4(1) + q4*rand(1,30); u4(2) + q4*rand(1,30)]; %Samplin Fourth Function
...
H = input('Number Of RBF Hidden Neurons = ');    % NUMBER OF RBF NEURONS
Centers = zeros(2,H);

Random = randperm(120);
Centers(:,1:H) = Samples(:,Random(1:H));
